...
export default function ClientMessagingPage() {
  ...
  const fetchConversations = useCallback(async () => {
    ...
    try {
      const endpoint = "/api/client/inquiries";
      ...
      if (data.inquiries) {
        const mapped: Conversation[] = data.inquiries.map((item: RawInquiry) => ({
          id: item.id,
          roomName: item.id,
          participantName: item.proName || "Professional",
          ...
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[10px] font-bold text-gray-500 uppercase tracking-tighter">Client Dashboard</p>
              </div>
            </div>
